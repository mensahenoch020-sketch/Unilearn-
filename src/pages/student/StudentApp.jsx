    ...
    >
      ...
      <div style={{ padding: "20px 20px", paddingBottom: showBottomNav ? 100 : 40 }}>
        <Routes>
          ...
          <Route path="/settings" element={<Settings user={user} setUser={setUser} C={C} onLogout={onLogout} />} />
          <Route path="/more" element={<More user={user} dark={dark} setDark={setDark} onLogout={onLogout} C={C} />} />
          <Route path="*" element={<Dashboard user={user} C={C} />} />
        </Routes>
      </div>
