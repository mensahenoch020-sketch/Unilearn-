...
export default function LecturerApp({ user, setUser, dark, setDark, C, onLogout }) {
  ...
  if (selAssignment) return (
    <div style={{ fontFamily: "Inter,sans-serif", background: C.bg, minHeight: "100vh", maxWidth: 480, margin: "0 auto" }}>
      <div style={{ background: C.headerBg, color: C.headerText, padding: "calc(14px + env(safe-area-inset-top)) 20px 14px", display: "flex", alignItems: "center", gap: 12, position: "sticky", top: 0, zIndex: 10 }}>
  ...
  return (
    <div style={{ fontFamily:"Inter,sans-serif", background:C.bg, minHeight:"100vh", maxWidth:480, margin:"0 auto" }}>
      ...
      <div style={{ background:C.headerBg, color:C.headerText, padding: "calc(14px + env(safe-area-inset-top)) 20px 14px", display:"flex", alignItems:"center", justifyContent:"space-between", position:"sticky", top:0, zIndex:10 }}>
